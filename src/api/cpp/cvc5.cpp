...
const static std::unordered_map<Kind, std::pair<internal::Kind, std::string>>
    s_kinds{
        ...
        KIND_ENUM(Kind::RELATION_RCLOSURE, internal::Kind::RELATION_RCLOSURE),
        KIND_ENUM(Kind::RELATION_RTCLOSURE, internal::Kind::RELATION_RTCLOSURE),
        KIND_ENUM(Kind::RELATION_ACYCLIC, internal::Kind::RELATION_ACYCLIC),
        KIND_ENUM(Kind::RELATION_MINIMAL, internal::Kind::RELATION_MINIMAL),
...
const static std::unordered_map<internal::Kind,
    ...
    s_kinds_internal{
        ...
        {internal::Kind::RELATION_RCLOSURE, Kind::RELATION_RCLOSURE},
        {internal::Kind::RELATION_RTCLOSURE, Kind::RELATION_RTCLOSURE},
        {internal::Kind::RELATION_ACYCLIC, Kind::RELATION_ACYCLIC},
        {internal::Kind::RELATION_MINIMAL, Kind::RELATION_MINIMAL},
